...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  <link rel="stylesheet" type="text/css" href="myprofiles.css">
...
<amp-sidebar id="sidebar" class="cid-rIduZ5xEHs" layout="nodisplay" side="right">
        <div class="builder-sidebar" id="builder-sidebar">
            ...
            <div class="sidebar mbr-white" data-app-modern-menu="true"><hr>
              <a class="text-primary display-2" href="signinkc.php">Masuk</a><hr>
...
<body>
  <div id="highlighted">
    ...
    <div>
      <div>
        <br><br><br><br><center><h1>LUPA SANDI</h1></center>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="content-area-right">
          ...
          <div class="row">
            <div class="col-md-5 forgot-form">
              <center><p>Tolong masukkan alamat email anda di bawah dan kami akan mengirim informasi untuk mengubah kata sandi anda.</p>
              <label class="label-default" for="un">Alamat Email</label> <input id="email_addy" name="email_addy" class="form-control" type="text"><br>
              <a id="mybad" class="btn btn-primary">Kirim</a>
            </div>
          </div>
        </div>
      </div>
